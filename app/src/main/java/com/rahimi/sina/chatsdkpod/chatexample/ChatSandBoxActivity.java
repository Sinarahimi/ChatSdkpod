package com.rahimi.sina.chatsdkpod.chatexample;
...
import com.rahimi.sina.chatsdkpod.R;
...
//                });
            ...
            case 5:
                ...
                messageIds.add(4409L);
                messageIds.add(4401L);
...
//                        , new Invitee(824, 2)
            ...
            case 9:
                ...
                presenter.getHistory(history, 107, new ChatHandler() {
                    @Override
